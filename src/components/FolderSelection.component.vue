<template>
    <div>
        <el-card class="box-card">
            <div slot="header">Select a folder of EAF files to get started.</div>
            <div class="w-full">
                <el-button @click="selectFolder">
                    <font-awesome-icon icon="folder-open"></font-awesome-icon>&nbsp;select folder
                </el-button>
                <span v-show="selectedFolder.name">{{selectedFolder.name}}</span>
            </div>
